...
// citation: https://codepen.io/JonnyNineToes/pen/AgEax

// To add javascript functionality - if javascript is enabled
$(document).ready(function () {
    // insert an "add more" button after the last element
  $('#count').before('<input class="add_btn" id="add_btn" type="button" value="Add more Questions" style="font-family: cursive ; color:green ; background-color: orange" > ');
